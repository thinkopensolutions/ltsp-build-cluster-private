...
sed_file /etc/ldap.conf "^uri ldap://${APPs[$DHCP_LDAP01_SERVER]}" "#uri ldap://${APPs[$DHCP_LDAP01_SERVER]}"

add_indexes || fail "Adding indexes"
replication_master_side || fail "Configurating replication"
